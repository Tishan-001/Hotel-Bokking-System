    ...
    public function store(Request $request)
    {
        ...
        if($request->ref=='front'){
            ...
            $session = \Stripe\Checkout\Session::create([
                ...
                'mode' => 'payment',
                'success_url' => 'http://localhost/laravel-apps/hotelBoking/booking/success?session_id={CHECKOUT_SESSION_ID}',
                'cancel_url' => 'http://localhost/laravel-apps/hotelBoking/booking/fail',
            ]);
